...
def generate_data_points(N_z, lb, ub):
    ...
    # the first column is the time, the second to the fifth are the states, and the sixth and seventh are the inputs
    # the first row is zeros --------> [0, 0, 0, 0, 0, 0, 0] (initial condition) t = 0 <--------
